                ...
                <div class="flex flex-wrap">
                    <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
                        <p class="text-xl pb-6 flex items-center">
                            <i class="fas fa-list mr-3"></i> Laporan Form
                        </p>
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl" action="{{ route('form_data_add') }}" method="POST">
                                @csrf
                                <div class="">
                                ...
                                <div class="mt-2">
                                    <label class="block text-sm text-gray-600" for="no_seri">NO SERI</label>
                                ...
                                <div class="mt-2">
                                    ...
                                    <select class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="status"
                                        ...
                                        <option value="DILANJUTKAN">SELESAI</option>
                                    </select>
                                </div>
